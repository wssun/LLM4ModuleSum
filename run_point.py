...
def main():
    prompt4 = """Please generate a concise comment to describe the functionality of the following code in an imperative mood:"""
    ...
    target_folder = '../project_cases/community'
    ...
    for json_file in json_files:
        ...
        print(f'处理文件: {json_file}，代码数量: {len(code)}')

        project_name = os.path.splitext(json_file)[0]
        output_csv_path = os.path.join('../result/file-level/GPT4/mothod3_communtiy/middle_result', f'{project_name}.csv')
